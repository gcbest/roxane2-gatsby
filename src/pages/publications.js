...
export default () => (
    <Layout>
        <article class="content">
			<h1 class="content-header">Publications</h1>
			<div class="publications-grid">
				...
				<div class="publication">
					<h3><a target="_blank" href="http://oshwiki.eu/wiki/Worker_participation_-_United_Kingdom">Worker
				...
				<div class="publication">
					<h3><a target="_blank" href="http://oshwiki.eu/wiki/Presenteeism:_An_overview">Presenteeism: An
							overview</a></h3>
				</div>
				<div class="publication">
					<h3><a target="_blank"
