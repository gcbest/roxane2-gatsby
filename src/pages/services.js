...
export default () => (
    <Layout contentHeader="Services">
        <div className="services">
            ...
            <p>Leaders are the essence of an organisation. They provide strategic direction, make essential decisions to ensure that the business’s functionality is effective; they solve any problems that may emerge; and they influence and support the workforce. This bespoke leadership development programme, inclusive of management training will assist the leaders in your organisation to enhance their individuals and business potential as well as improve their ability to gain the trust, respect, commitment and support of their teams.</p>
        </div>
    </Layout>
);